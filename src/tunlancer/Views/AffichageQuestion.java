...
public class AffichageQuestion {
  ...
  private  static Competence  questions;
    public AffichageQuestion() {
        ...
        lb = new SpanLabel("");
        ServiceCompetence Question=new ServiceCompetence();
        ServiceCompetence n = new ServiceCompetence();
        ArrayList<Competence> lstC =  n.getAllCompetences();;
        SpanLabel lb;
     ...
     for (Competence c : lstC) {
        ...
        Label ll = new Label("Question :"+ c.getTitre());
        ll.getAllStyles().setFont(Font.createSystemFont(Font.FACE_SYSTEM, Font.STYLE_BOLD, Font.SIZE_MEDIUM));
        mainContainer.add(buildPairLabel("reponse 1 ", c.getTitre()));
        mainContainer.add(buildPairLabel("reponse 2 ", c.getDomaine()));
        mainContainer.add(buildPairLabel("reponse 3 ",c.getDomaine()));
 ...
 edit.addPointerReleasedListener(E->{
       questions = c;
      EditCompetence mod =new EditCompetence(f,c);
       mod.getF().show();
