...
public class PublicationsForm extends BaseForm {
    ...
    public PublicationsForm(Resources res) {
        ...
        /*for (int i = 0; i < publications.size(); i++) {
            addPublication(res.getImage("news-item-1.jpg"), publications.get(i).getDescription(), false, 26, 32);
        }*/
        
        addPublicationToForm(res.getImage("back.png"), "test description", false, 26, 32);
    }
    ...
    private void addPublicationToForm(Image img, String title, boolean liked, int likeCount, int commentCount) {
